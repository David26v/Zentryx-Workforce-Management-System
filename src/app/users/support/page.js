    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {Object.keys(helpTopics).map((topic, index) => (
                  <li key={index}>
                    <button 
                      ...
                      className={`flex items-center text-gray-700 hover:text-indigo-600 transition w-full text-left p-2 rounded-lg ${
          ...
          {/* Main Content Area - Help Content or Chat */}
                ...
                <div className="p-5 border-b">
                  <div className="flex items-center">
                    <div className="relative mr-3">
                      ...
                      <Settings className="w-3 h-3 absolute -bottom-0.5 -right-0.5 text-indigo-400" />
                    </div>
                    <div>
                      <h2 className="font-semibold text-gray-900">Zentri Assistant</h2>
                      <p className="text-xs text-gray-500">AI support - Online now</p>
                    </div>
                  </div>
                </div>
